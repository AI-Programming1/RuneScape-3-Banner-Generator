...
function generateIframe(username, game) {
  ...
  let src = `your-template.html?user=${encodeURIComponent(username)}&color=${encodeURIComponent(currentTextColor)}&game=${encodeURIComponent(game)}&font=${encodeURIComponent(currentFont)}&mode=${encodeURIComponent(currentMode)}`;
